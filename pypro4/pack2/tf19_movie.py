...
(x_train, y_train), (x_test, y_test) = imdb.load_data(num_words=10000)  # 자주보이는 단어 만개만 쓰겠다.
...
print(len(x_val), len(partial_x_train)) # 10000 150000
y_val = y_train[:10000]
...
# 가중치 규제란 말 그대로 가중치의 값이 커지지 않도록 제한하는 법이다.
