...
# 3. 모델 학습과정 설정(컴파일)
# model.compile(optimizer='sgd', loss = 'binary_crossentropy', metrics = ['accuracy']) # 'sgd' = 확률적 경사 하강법
...
print('저장된 모델 읽어서 예측결과 : ', (model2.predict(x) > 0.5).astype('int32'))